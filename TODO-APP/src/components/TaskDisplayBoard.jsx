  ...
  return (
    <>
      <div className="task-display-board-container w-full px-3 py-2 mt-4">
        <div className="display-board-wrapper flex gap-2.5 justify-center items-center flex-wrap">
          {tasks.map((task, index) => (
            <div
              className="task-contaienr bg-primary-text text-primary-bg text-lg font-medium px-3 py-2 rounded-lg flex flex-col justify-center items-center gap-4 hover:scale-105 duration-200 cursor-pointer shadow-xl/30 shadow-white"
              key={index}
            >
              ...
              <div className="task-dtls-box flex gap-1.5">
                <span className="task-priority px-2 py-1 bg-secondary-bg rounded-3xl shadow-xl/15 shadow-border-shadow">
                  {task.taskPriority}
                </span>
                <span className="task-category px-2 py-1 bg-secondary-bg rounded-3xl shadow-xl/15 shadow-border-shadow">
                  {task.taskCategory}
                </span>
                <span className="task-due-date px-2 py-1 bg-secondary-bg rounded-3xl shadow-xl/15 shadow-border-shadow">
                  {task.taskDueDate}
                </span>
              </div>
            </div>
